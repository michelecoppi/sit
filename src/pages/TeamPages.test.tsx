...
const team: TeamDetail = {
  ...
  progression: {
    ...
    missionPolicy: {
      ...
      canCreateToday: true,
      nextCreationAt: null,
      availableDifficulties: [{ difficulty: 'standard', label: 'Standard', description: 'Normal objective.', baseTeamXp: 50, requiredLevel: 1, unlocked: true, assignedReward: 50, teamReward: 60 }],
    },
  },
