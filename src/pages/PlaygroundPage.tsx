...
const outputClassName = 'mt-3 min-h-32 overflow-auto rounded-[1.2rem] border border-slate-200 bg-slate-50 p-4 font-mono text-sm leading-6 text-slate-800 shadow-inner ring-1 ring-slate-200/70 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100 dark:ring-slate-800/70'
